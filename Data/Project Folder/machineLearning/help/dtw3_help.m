...
%
% <html>
% <p>dtw3(vec1, vec2, beginCorner, endCorner, plotOpt, distanceBound) returns the DTW distance between vec1 and vec2, assuming a local path constrains of 0 and 45 degrees.
% 	<ul>
...
% 	</ul>
% <p>[minDist, dtwPath, dtwTable] = dtw3(...) also return two extra results:
% 	<ul>
