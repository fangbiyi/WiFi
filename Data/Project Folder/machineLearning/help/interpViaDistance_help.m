%% interpViaDistance
% Interpolation via weighting of reciprocal distance
%% Syntax
% * 		out=interpViaDistance(x, sampleInput, sampleOutput)
%% Description
%
% <html>
% <p>out=interpViaDistance(x, sampleInput, sampleOutput) returns the interpolated value based on sampleInput and sampleOutput, using weighting factors of reciprocal distance.
% 	<ul>
...
axis tight
%% See Also
% <interpViaGaussian_help.html interpViaGaussian>.
