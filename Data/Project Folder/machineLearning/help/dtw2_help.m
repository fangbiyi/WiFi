...
%
% <html>
% <p>dtw2(vec1, vec2, beginCorner, endCorner, plotOpt, distanceBound) returns the DTW distance between vec1 and vec2, assuming a local path constrains of 0, 45, and 90 degrees.
% 	<ul>
...
% 	</ul>
% <p>[minDist, dtwPath, dtwTable] = dtw2(...) also return two extra results:
% 	<ul>
