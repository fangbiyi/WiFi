...
% set(gcf, 'PaperPosition', [0 -.1 10 3.8]); %Position plot at left hand corner with width 5 and height 5.
% set(gcf, 'PaperSize', [10 4]); %Set the paper to have width 5 and height 5.
% saveas(gcf, filename, 'pdf'); 
% saveas(gcf,strcat(filename,'.fig'));
% saveas(gcf,strcat(filename,'.eps'),'eps2c');